...
namespace DemoWorkflowConsoleApplication {
    ...
    public partial class StateMachineWorkFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(StateMachineWorkFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(StateMachineWorkFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(StateMachineWorkFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".StateMachineWorkFlow.g.xaml") || resource.Equals("StateMachineWorkFlow.g.xaml"))) {
                    return resource;
                }
            }
